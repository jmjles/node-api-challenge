...
Error Handling and that express no has bodyparser built in

- [ ] Describe Middleware?
A Function that is run in-between request/response

- [ ] Describe a Resource?
A resource is an Uri that can gbe referenced to in development and production

- [ ] What can the API return to help clients know if a request was successful?
A response to let the user know that it was successful such as a code 200
